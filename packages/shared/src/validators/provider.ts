...
const providers = ["google", "microsoft", "s3", "box"] as const;
const providerSlugs = ["g", "m", "s3", "b"] as const;
...
export type DriveProviderSlugParam = z.infer<typeof driveProviderSlugParamSchema>;
