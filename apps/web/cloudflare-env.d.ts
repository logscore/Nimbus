/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 0ca42b4b83d81e012adae46f68df4ae6)
// Runtime types generated with workerd@1.20250709.0 2025-05-18 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_BACKEND_URL: "http://localhost:1284" | "https://nimbus-server.logan-def.workers.dev";
		NEXT_PUBLIC_FRONTEND_URL: "http://localhost:3000" | "https://nimbus-web.logan-def.workers.dev";
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_BACKEND_URL" | "NEXT_PUBLIC_FRONTEND_URL">> {}
}
